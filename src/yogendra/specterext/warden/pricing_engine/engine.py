...
def historical_prices(ticker, fx='USD', source=None):
    ...
    from .alphavantage import historical as aa_historical
    from .cryptocompare import historical as cc_historical
    from .fmp import historical as fmp_historical
    from .twelvedata import historical as td_historical
...
def realtime_price(ticker, fx=None, source=None, parsed=True):
    ...
    if fx == 'USD':
        ...
        from .alphavantage import realtime as aa_realtime
    ...
    from .alphavantage import realtime as aa_realtime
    from .cryptocompare import realtime as cc_realtime
    from .fmp import realtime as fmp_realtime
    from .twelvedata import realtime as td_realtime
