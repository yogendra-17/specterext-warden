...
function run_ajax() {
    ...
    $.ajax({
        type: "GET",
        dataType: 'json',
        url: "/svc/warden/api/drawdown_json?ticker=" + ticker + "&start=" + start_date + "&end=" + end_date + "&n_dd=" + n_dd,
    ...
    $.ajax({
        type: "GET",
        dataType: 'json',
        url: "/svc/warden/api/drawdown_json?ticker=" + ticker + "&start=" + start_date + "&end=" + end_date + "&n_dd=" + n_dd + "&chart=True",
