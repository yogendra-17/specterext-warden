...
$(document).ready(function () {
    ...
    $('#dismiss_balances').click(function () {
        ...
        $.ajax({
            ...
            dataType: "json",
            url: "/svc/warden/api/dismiss_notification",
    ...
    function updateModal(this_var) {
        ...
        $.ajax({
            type: 'GET',
            url: '/svc/warden/api/accounting_json?ticker=' + ticker + '&method=' + accounting,
            dataType: 'html',
    ...
    function onPopoverHtmlLoad() {
        ...
        $.ajax({
            type: 'GET',
            url: '/svc/warden/api/positions_json',
            dataType: 'json',
            success: function (data) {
                // Parse data
    ...
    $.ajax({
        type: 'GET',
        url: '/svc/warden/api/navchartdatajson',
        dataType: 'json',
        success: function (data) {
            navChart(data);
        }
    ...
    $.ajax({
        type: 'GET',
        url: '/svc/warden/api/stackchartdatajson',
        dataType: 'json',
        success: function (data) {
            stackChart(data);
        }
    ...
    $.ajax({
        type: 'GET',
        url: '/svc/warden/api/fiatchartdatajson',
        dataType: 'json',
        success: function (data) {
            fiatChart(data);
        }
    ...
    $.ajax({
        type: 'GET',
        url: '/svc/warden/api/btcchartdatajson',
        dataType: 'json',
        success: function (data) {
            btcChart(data);
        }
...
function update_mempool() {
    $.ajax({
        type: 'GET',
        url: '/svc/warden/api/mempool_json',
        dataType: 'json',
        success: function (data) {
